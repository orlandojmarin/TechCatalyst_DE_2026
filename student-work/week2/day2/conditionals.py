# 1. Prediction: Handle in standard queue
claim_amount = 5000
...
# 2. Prediction: Short policy code accepted
policy = "AUTO"
if len(policy) < 5:
...
# 3. Prediction: Claim is overdue for review
claim_age_days = 21
...
# 5. Prediction: Approved via manager override
payout = 18000
authority_level = 1
