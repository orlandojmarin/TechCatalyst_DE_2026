...
| [Plotly Express](https://plotly.com/python/plotly-express/) | Reach for this when you need a Plotly chart type or styling option, such as the `px.bar` call in Activity 2 or the `px.line` and `fig.add_scatter` calls in Activities 5 and 6 |
